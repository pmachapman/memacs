...
#define GRAPHIC 1	/* character conversion to graphics functions	*/
#define LIBHELP 1	/* help des fonctions de la bibliotheque C	*/
			/* d'apres la version de Mark Williams		*/
#define EXTKEYS 0	/* supplemental key bindings for DOS and ST520 */
#define NEWVARS 1	/* supplemental environment variables		*/
#define	CETKEYS	0	/* use CET Basic compatible /etc/termcap	*/
