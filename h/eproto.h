...
extern void PASCAL longop (int f);
extern int PASCAL filenamedlg (char *prompt, char *buf, int nbuf, int fullpath);
extern void PASCAL NEAR vtfreescr (SCREEN *sp);
extern void PASCAL NEAR unlist_screen(SCREEN *sp);
extern void PASCAL mlhistory(VOID);
extern void PASCAL updscrollbars (SCREEN *sp, char w_flag);
